...
namespace ConsoleApp22
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nAfter removing two elements from items:" + $"Count={items.Count}" + $"Count ={items.Count};Capacity={items.Capacity}");


            Console.WriteLine("\n\"red\"is" + $"is" + $"{(items.Contains("red") ? string.Empty : "not")} in the list");
